...
CREATE TABLE wp_campaigns (
  ...
  slug VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'Campaign slug',
  summery VARCHAR(256) NOT NULL DEFAULT '' COMMENT 'Campaign summery',
  image_url VARCHAR(256) NOT NULL DEFAULT '' COMMENT 'Campaign Image URL',
  page_url VARCHAR(256) NOT NULL DEFAULT '' COMMENT 'Campaign webpage URL',
...
CREATE TABLE wp_images (
  ...
  image_url VARCHAR(256) NOT NULL DEFAULT '' COMMENT 'URL of image',
...
CREATE TABLE wp_pages (
  ...
  page_url VARCHAR(256) NOT NULL DEFAULT '' COMMENT 'URL of image',
  bitly_url VARCHAR(128) NOT NULL DEFAULT '' COMMENT 'Webpage Bitly URL',
